...
class createpurchaseorder(models.TransientModel):
	...
	date_order = fields.Datetime(srting = 'Order Date', required=True, copy=False, default=fields.Datetime.now)
...
class Getsaleorderdata(models.TransientModel):
	...
	date_planned = fields.Datetime(string='Scheduled Date', default = datetime.today(), store=True, index=True)
